    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/steg">
            <Button size="lg" className="bg-lime-500 hover:bg-lime-600 text-black font-bold text-lg px-8 py-6 w-full sm:w-auto transition-all shadow-[0_0_20px_rgba(132,204,22,0.3)] hover:shadow-[0_0_30px_rgba(132,204,22,0.5)]">
              Launch Steg Suite
            </Button>
          </Link>
          <Link href="/cheatsheet">
            <Button size="lg" variant="outline" className="text-lg px-8 py-6 w-full sm:w-auto border-zinc-700 hover:bg-zinc-800 transition-all">
              View Cheatsheets
            </Button>
          </Link>
        </div>
